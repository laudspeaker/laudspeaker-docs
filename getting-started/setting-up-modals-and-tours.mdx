---
title: "Setting up Modals and In-App Tours"
description:
...
We've included a sample app, based off of docusaurus here. You can see where we added the Laudspeaker code. All you'll need to do is add the correct api key and the application should work as intended.
