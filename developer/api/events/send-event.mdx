...
For a walkthrough check out this [guide](getting-started/setting-up-events)
...
An event must contain an **event** field (string), **correlationKey** field (string), **correlationValue** field (string), and a **source** set to **"custom"**
