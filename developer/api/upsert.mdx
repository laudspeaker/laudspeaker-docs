...
<ParamField query="keys and values" type="json" optional>
 You can add as many keys and properties as you want for the person here. 
</ParamField>
...
| Method   | Description                                      |
| -------- | ------------------------------------------------ |
| `POST`   | https://api.laudspeaker.com/customers/upsert     |
