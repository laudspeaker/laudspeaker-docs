...
Laudspeaker is an open source customer engagement suite (also called marketing automation software). If you've used tools like braze, one signal, airship, iterable, customer io or some others, Laudspeaker is an alternative to them. The main things that you can do with laudspeaker is
