...
### Creating a Person
You can create people manually, or if you have an event integration set up, profiles will be created automatically, as an event with that person reaches Laudspeaker.

To create a person manually, first click on the "new person" button on the people page. This will take you to an empty profile page like this:
...
Finally when you are done, adding attributes, you can save.

![Example Flow](/images/guides/product-manual/people_save.png)

### Editing a Person

You can also edit any person, whether you initially created the person manually, or if they were created automatically. Just click on edit, and add attributes.

### Syning Users, Events and Profiles
...
If you have an events integration, like the PostHog integration, if an event reaches Laudspeaker which has a user id that Laudspeaker has not seen before, we will automatially create a new profile. You do not have to do anything to set this up, beyond configuring the event integration.
