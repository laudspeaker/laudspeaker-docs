...
If you have an events integration, like the PostHog integration, if an event reaches Laudspeaker which has a user id that Laudspeaker has not seen before, we will automatically create a new profile. You do not have to do anything to set this up, beyond configuring the event integration.
